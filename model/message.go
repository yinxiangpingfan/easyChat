...
type Message struct {
	...
	Uuid       string     `gorm:"uniqueIndex;type:char(20);column:uuid;not null;comment:消息uuid"`
	SessionId  string     `gorm:"type:char(20);column:session_id;index;not null;comment:会话uuid"`
	...
	SendId     string     `gorm:"type:char(20);column:send_id;index;not null;comment:发送者uuid"`
	...
	ReceiveId  string     `gorm:"type:char(20);column:receive_id;index;not null;comment:接受者uuid"`
