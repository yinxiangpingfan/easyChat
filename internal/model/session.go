...
type Session struct {
	...
	Uuid          string     `gorm:"uniqueIndex;type:char(45);column:uuid;comment:会话uuid"`
	SendId        string     `gorm:"type:char(45);column:send_id;index;not null;comment:创建会话人id"`
	ReceiveId     string     `gorm:"type:char(45);column:receive_id;index;not null;comment:接受会话人id"`
